...
const Marquee3D = () => {
  return (
    <div>
      ...
      <div className="relative flex h-full w-[900px] mx-auto flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border bg-background px-24 md:shadow-xl">
