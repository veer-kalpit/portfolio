...
const CreativeBtn: React.FC<CreativeBtnProps> = ({ text, link }) => {
  return (
    <Link href={link} passHref>
      <div className="group relative cursor-pointer p-2 w-[180px] h-11 border bg-white rounded-full overflow-hidden text-black text-center font-[Tektur]">
        <span className="translate-x-1 group-hover:translate-x-12 group-hover:opacity-0 transition-all duration-300 inline-block -mr-2">
          {text}
        </span>
